...
bot.on ("message"  , async message  =>  {
    ...
    const server = message.guild;
      ...
      if (message.author.bot) return;
         ...
         message.author.send("Ight,imma send that to Blazing.My DMs r closed kiddo.If you wanna contact server/tourney support,or get tourney payment,type *+help* inside this  server.")
...
member.send(`Welcome to the Relics, ${member.user.username}! :tada: Make sure you check out our official Relics  club in Brawl Stars,and join us in if you're looking for a NOICE,active and friendly club! Also,make sure u send a screenshot of your profile in the verification channel if you aren't already verified in a relics server!
